...
contract RaffleTest is CodeConstants, Test {
    ...
    function testEnterRaffleRevertWhenNotPayEnoughETH() public {
        // Arrange
        vm.prank(PLAYER);
        // Act / Assert
    ...
    // What if we need to get a data from emitted events in our tests?
    ...
    function testFullfillrandomWordsCanOnlyBeCalledAfterPerformUpkeek(uint256 randomRequestId) public raffleEntered skipFork {
        // Arrange
